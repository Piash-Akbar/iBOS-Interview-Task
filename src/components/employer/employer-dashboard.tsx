...
import { ExamCard } from "@/components/employer/exam-card";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link href="/exams/create">
          <Button className="shrink-0">Create Online Test</Button>
        </Link>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Create your first online test to start assessing candidates."
        />
      ) : (
        <>
